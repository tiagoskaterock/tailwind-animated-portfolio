				...
				<div class="grid grid grid-cols-[repeat(auto-fit,minmax(220px,1fr))] gap-8">
					...
					<article class="bg-card-color py-12 px-8 border-b-2 border-transparent">
						...
						<svg 
							xmlns="http://www.w3.org/2000/svg" 
							viewBox="0 0 24 24" 
							class="icons w-24"><path d="M12 22c3.719 0 7.063-2.035 8.809-5.314L13 12l7.809-4.686C19.063 4.035 15.719 2 12 2 6.486 2 2 6.486 2 12s4.486 10 10 10zm-.5-16a1.5 1.5 0 1 1-.001 3.001A1.5 1.5 0 0 1 11.5 6z"></path></svg>
						<h3 class="text-2xl text-gray-color font-medium">
							Game Development
						</h3>
